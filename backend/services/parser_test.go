...
func TestParseFilename(t *testing.T) {
	tests := []struct {
		...
		{name: "S02E01.mkv", wantTitle: "", wantNumber: 1, wantSeason: 2, wantKind: "episode"},
		{name: "01.mkv", wantTitle: "", wantNumber: 1, wantKind: "episode"},
		{name: "02.mkv", wantTitle: "", wantNumber: 2, wantKind: "episode"},
