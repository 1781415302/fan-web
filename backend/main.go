...
func main() {
	...
	bangumiSync := services.NewBangumiSync(bangumiService)
	episodeHandler.SetBangumiSync(bangumiSync)
	bangumiMeHandler := handlers.NewBangumiMeHandler(bangumiService, bangumiSync)
	...
	api.Use(middleware.RequireSetup(setupHandler.IsConfigured))
	{
		...
		protected.GET("/progress/continue", episodeHandler.Continue)
		...
		protected.GET("/me/bangumi", bangumiMeHandler.Get)
		protected.PUT("/me/bangumi", bangumiMeHandler.Put)
		protected.DELETE("/me/bangumi", bangumiMeHandler.Delete)
		protected.POST("/me/bangumi/sync", bangumiMeHandler.Sync)
		...
		manager.GET("/library/scan", libraryHandler.Status)
		manager.GET("/library/unidentified", libraryHandler.Unidentified)
		manager.GET("/library/dirs", libraryHandler.Dirs)
		manager.POST("/animes/:id/rebind", animeHandler.Rebind)
